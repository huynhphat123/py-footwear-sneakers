...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    categoryName: 'Giày Bóng Rổ (Basketball)',
    gender: 'Unisex',
    description: 'Bản phối màu kinh điển được săn lùng hàng đầu của Air Jordan 4. Sự kết hợp giữa da bò cao cấp màu trắng ngà, các chi tiết lưới TPU đen tuyền và đệm viền da lộn xám neutral mang lại vẻ ngoài đỉnh cao cho giới mộ điệu.',
    shortDescription: 'Biểu tượng Air Jordan 4 phối màu Military Black sang trọng, đệm Air gót êm ái.',
    ...
    variants: generateVariants('p-13', ['40', '41', '42', '42.5', '43', '44'], [{ name: 'Military Black', hex: '#111827' }], 7500000, 6890000),
    rating: 5.0,
    reviewCount: 189,
    seoTitle: 'Air Jordan 4 Military Black Chính Hãng | PY',
    seoDescription: 'Mua Air Jordan 4 Military Black chuẩn Auth 100%, bảo hành keo chỉ 12 tháng.',
    createdAt: '2025-02-20T10:00:00Z',
  },
  {
    id: 'p-14',
    name: 'Nike Air Max 97 OG Silver Bullet',
    slug: 'nike-air-max-97-og-silver-bullet',
    sku: 'NK-AM97-SLV-BLT',
    brandId: 'b-nike',
    brandName: 'Nike',
    categoryId: 'c-sneaker',
    categoryName: 'Sneaker & Lifestyle',
    gender: 'Unisex',
    description: 'Lấy cảm hứng từ đoàn tàu cao tốc Shinkansen Nhật Bản với các đường gợn sóng phản quang 3M lấp lánh trong bóng tối. Đệm khí Full-length Air chạy dọc toàn bộ bàn chân tạo cảm giác nhún êm ấn tượng.',
    shortDescription: 'Cảm hứng tàu cao tốc Shinkansen Nhật Bản cùng dải phản quang 3M nổi bật.',
    originalPrice: 4800000,
    salePrice: 4290000,
    costPrice: 3100000,
    status: 'active',
    ...
    variants: generateVariants('p-14', ['38', '39', '40', '41', '42', '43'], [{ name: 'Metallic Silver', hex: '#E5E7EB' }], 4800000, 4290000),
    rating: 4.9,
    reviewCount: 135,
    seoTitle: 'Nike Air Max 97 Silver Bullet | PY',
    seoDescription: 'Giày Nike Air Max 97 Silver Bullet chính hãng giá tốt nhất.',
    createdAt: '2025-01-22T14:00:00Z',
  },
  {
    id: 'p-15',
    name: 'New Balance 530 Steel Grey Metallic',
    slug: 'new-balance-530-steel-grey-metallic',
    sku: 'NB-530-STL-GRY',
    brandId: 'b-newbalance',
    brandName: 'New Balance',
    categoryId: 'c-sneaker',
    categoryName: 'Sneaker & Lifestyle',
    gender: 'Unisex',
    description: 'Mẫu giày dad-shoe hot trend càn quét khắp mạng xã hội châu Á. Thân lưới thoáng mát, trọng lượng siêu nhẹ và bộ đệm ABZORB hấp thụ lực chấn động tuyệt hảo cho việc đi bộ cả ngày dài.',
    shortDescription: 'Dad-shoe quốc dân phong cách Hàn Quốc với đệm ABZORB siêu êm.',
    ...
    variants: generateVariants('p-15', ['36', '37', '38', '39', '40', '41', '42', '43'], [{ name: 'Steel Grey', hex: '#9CA3AF' }, { name: 'White Silver', hex: '#F3F4F6' }], 2800000, 2490000),
    rating: 4.9,
    reviewCount: 310,
    seoTitle: 'New Balance 530 Steel Grey | PY',
    seoDescription: 'Giày New Balance 530 retro phong cách Hàn Quốc siêu êm thoáng.',
    createdAt: '2025-02-05T09:00:00Z',
  },
  {
    id: 'p-16',
    name: 'Adidas Gazelle Indoor Blue Fusion Gum',
    slug: 'adidas-gazelle-indoor-blue-fusion-gum',
    sku: 'AD-GAZ-IND-BLU',
    brandId: 'b-adidas',
    brandName: 'Adidas',
    categoryId: 'c-sneaker',
    categoryName: 'Sneaker & Lifestyle',
    gender: 'Unisex',
    description: 'Phiên bản Gazelle Indoor với chất da lộn mịn màng phủ tone xanh rực rỡ, đế cao su gum bán trong suốt ôm trọn gót chân mang đến phong cách thời trang đường phố thanh lịch và cuốn hút.',
    shortDescription: 'Chất liệu da lộn mềm mịn cùng đế cao su gum trong suốt tinh tế.',
    originalPrice: 3200000,
    salePrice: 2790000,
    costPrice: 1900000,
    status: 'active',
    ...
    variants: generateVariants('p-16', ['37', '38', '39', '40', '41', '42'], [{ name: 'Blue Fusion / Gum', hex: '#3B82F6' }], 3200000, 2790000),
    rating: 4.8,
    reviewCount: 96,
    seoTitle: 'Adidas Gazelle Indoor Blue | PY',
    seoDescription: 'Giày Adidas Gazelle Indoor chính hãng phối màu độc quyền.',
    createdAt: '2025-02-16T11:00:00Z',
  },
  {
    id: 'p-17',
    name: 'Asics GT-2160 Pure Silver Sheet Rock',
    slug: 'asics-gt-2160-pure-silver-sheet-rock',
    sku: 'AS-GT2160-SLV',
    brandId: 'b-asics',
    brandName: 'Asics',
    categoryId: 'c-running',
    categoryName: 'Giày Chạy Bộ (Running)',
    gender: 'Unisex',
    description: 'Kế thừa ngôn ngữ thiết kế kỹ thuật của dòng GT-2000 đầu thập niên 2010. Khung đế phân đoạn với công nghệ đệm Gel đặc trưng mang lại khả năng chống shock và hỗ trợ bước đi cực kỳ chắc chắn.',
    shortDescription: 'Thiết kế chạy bộ thập niên 2010 với công nghệ đệm Gel công thái học.',
    ...
    variants: generateVariants('p-17', ['39', '40', '41', '42', '43', '44'], [{ name: 'Pure Silver', hex: '#D1D5DB' }], 3600000, 3190000),
    rating: 4.9,
    reviewCount: 54,
    seoTitle: 'Asics GT-2160 Pure Silver | PY',
    seoDescription: 'Giày Asics GT-2160 chính hãng phong cách gorpcore thời thượng.',
    createdAt: '2025-02-19T08:30:00Z',
  },
  {
    id: 'p-18',
    name: 'Nike Dunk Low Coast University Blue',
    slug: 'nike-dunk-low-coast-university-blue',
    sku: 'NK-DUNK-CST-BLU',
    brandId: 'b-nike',
    brandName: 'Nike',
    categoryId: 'c-sneaker',
    categoryName: 'Sneaker & Lifestyle',
    gender: 'Unisex',
    description: 'Sự hòa quyện ngọt ngào giữa màu xanh bờ biển University Blue và nền da trắng tinh khiết, điểm xuyết chi tiết thêu vàng ánh dương sau gót. Đôi giày hoàn hảo cho những ngày hè rực rỡ.',
    shortDescription: 'Phối màu University Blue mát mẻ kết hợp da mịn cao cấp dễ thương.',
    originalPrice: 4200000,
    salePrice: 3690000,
    costPrice: 2600000,
    status: 'active',
    ...
    variants: generateVariants('p-18', ['36', '37', '38', '39', '40', '41'], [{ name: 'Coast Blue / White', hex: '#60A5FA' }], 4200000, 3690000),
    rating: 4.9,
    reviewCount: 167,
    seoTitle: 'Nike Dunk Low Coast University Blue | PY',
    seoDescription: 'Nike Dunk Low Coast chính hãng phối màu xanh pastel thời thượng.',
    createdAt: '2025-01-25T13:00:00Z',
  },
  {
    id: 'p-19',
    name: 'Puma Suede Classic XXI Black White',
    slug: 'puma-suede-classic-xxi-black-white',
    sku: 'PM-SUEDE-XXI-BLK',
    brandId: 'b-puma',
    brandName: 'Puma',
    categoryId: 'c-heritage',
    categoryName: 'Classic & Heritage',
    gender: 'Unisex',
    description: 'Huyền thoại đường phố từ năm 1968 đại diện cho văn hóa b-boy và hip-hop thế giới. Thân giày da lộn cao cấp, form ôm chân thoải mái cùng dải Formstrip trắng kinh điển không thể nhầm lẫn.',
    shortDescription: 'Tượng đài Hip-Hop 1968 với chất da lộn mềm mịn và form dáng bất hủ.',
    ...
    variants: generateVariants('p-19', ['38', '39', '40', '41', '42', '43'], [{ name: 'Black / White', hex: '#111827' }], 2200000, 1850000),
    rating: 4.8,
    reviewCount: 128,
    seoTitle: 'Puma Suede Classic XXI Chính Hãng | PY',
    seoDescription: 'Mua Puma Suede Classic da lộn chính hãng cam kết đền 200% nếu fake.',
  ...
  },
  {
    ...
    categoryName: 'Sneaker & Lifestyle',
    gender: 'Unisex',
    description: 'Siêu phẩm collab đắt giá nhất mọi thời đại giữa Jordan Brand và nghệ sĩ Cactus Jack. Dấu Swoosh đảo ngược biểu tượng, chất da nubuck nâu Mocha thượng hạng cùng các chi tiết thêu mặt cười Cactus Jack sau gót.',
    shortDescription: 'Bản hợp tác huyền thoại Travis Scott x Jordan với Swoosh ngược trứ danh.',
    ...
    variants: generateVariants('p-20', ['40', '41', '42', '42.5', '43', '44'], [{ name: 'Reverse Mocha', hex: '#78350F' }], 18500000, 16900000),
    rating: 5.0,
    reviewCount: 420,
    seoTitle: 'Jordan 1 Low Travis Scott Reverse Mocha | PY',
    seoDescription: 'Siêu phẩm Jordan 1 Low Travis Scott Reverse Mocha chính hãng nguyên seal.',
...
export const INITIAL_BLOGS: BlogPost[] = [
  {
    ...
    summary: 'Từ vẻ đẹp vượt thời gian của Nike Air Force 1 đến trào lưu Blokecore cùng Adidas Samba, cùng điểm qua những đôi giày đáng đầu tư nhất năm.',
...
Hãy ghé các cửa hàng PY trên toàn quốc để trải nghiệm và được tư vấn size chuẩn xác nhất!`,
  ...
  },
  {
    ...
    summary: 'Hướng dẫn chi tiết từng bước làm sạch chất liệu da, vải canvas và khử ố vàng đế cao su cực kỳ an toàn tại nhà.',
...
- **Bước 4**: Phơi ở nơi thoáng gió, tránh ánh nắng mặt trời trực tiếp. Sử dụng cây giữ form giày (shoe trees) để giữ dáng giày luôn phẳng phiu.`,
  ...
  },
  {
    ...
    summary: 'Cách đo chiều dài bàn chân chính xác tại nhà và bảng quy đổi size US, UK, EU, CM của từng thương hiệu lớn.',
...
- Cộng thêm 0.5cm - 1.0cm để có độ cử động ngón chân thoải mái.`,
    ...
    coverImage: 'https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?w=800&auto=format&fit=crop&q=80',
...
export const initialBlogPosts = [
  {
    ...
    summary: 'Khám phá những mẫu giày sneaker màu trung tính thanh lịch, đệm êm ái hỗ trợ đứng cả ngày mà vẫn chuẩn phong cách smart-casual cho dân công sở.',
    category: 'Xu Hướng & Phong Cách',
  ...
  },
  {
    ...
    summary: 'Chia sẻ các bước làm sạch giày da, vải canvas và đế cao su với dung dịch chuyên dụng, bí quyết phơi khô giúp giày giữ màu trắng sáng như mới.',
    category: 'Bảo Quản & Chăm Sóc',
  ...
  },
  {
    ...
    summary: 'Tổng hợp bảng quy đổi size US/UK/EU/CM của các hãng Nike, Adidas, Jordan, New Balance và mẹo đo chiều dài bàn chân chính xác tại nhà.',
    category: 'Cẩm Nang Mua Sắm',
    author: 'PY Support',
